  ...
  return (
    <section id="top" ref={wrapRef} className="relative overflow-hidden pt-24 sm:pt-28 md:pt-32">
      <div aria-hidden className="pointer-events-none absolute inset-0 -z-10 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-[oklch(0.14_0.03_265)]/60 via-[oklch(0.14_0.03_265)]/75 to-[oklch(0.14_0.03_265)]" />
      </div>
      <motion.div aria-hidden
        className="pointer-events-none absolute -left-24 bottom-10 h-56 w-56 rounded-full bg-[oklch(0.78_0.15_85)]/10 blur-3xl"
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6">
        ...
        <div className="relative overflow-hidden py-1">
          ...
          >
            <span className="mr-2 text-[oklch(0.86_0.13_88)]">&amp;</span>Constructions
          </motion.div>
        </div>
        <div className="mx-auto mt-6 h-px w-24 bg-gradient-to-r from-transparent via-[oklch(0.86_0.13_88)] to-transparent" />
        ...
        <div className="mt-8 flex flex-wrap items-center justify-center gap-3 sm:mt-10">
          <Link to="/projects"
            className="rounded-full bg-[oklch(0.78_0.15_85)] px-7 py-3 text-[11px] font-bold uppercase tracking-[0.3em] text-[oklch(0.15_0.03_265)]">
            View Our Work
          </Link>
          <Link to="/contact"
            className="rounded-full border border-white/20 px-7 py-3 text-[11px] font-bold uppercase tracking-[0.3em] text-white/80 hover:border-[oklch(0.78_0.15_85)] hover:text-[oklch(0.86_0.13_88)]">
            Start a Project
          </Link>
        </div>
      ...
      <div className="marquee flex gap-8 whitespace-nowrap sm:gap-12">
        {doubled.map((t, i) => (
          <span key={i} className="flex items-center gap-8 font-display text-xl font-black text-white/40 sm:gap-12 sm:text-3xl md:text-5xl">
            {t}
            <span className="text-[oklch(0.78_0.15_85)]">✦</span>
          </span>
        ))}
      </div>
    </div>
    ...
    <section id="story" className="relative overflow-hidden py-20 md:py-40">
      <div ref={ref}>
        <div className="mx-auto grid max-w-7xl gap-12 px-4 sm:px-6 md:grid-cols-2 md:gap-20">
          <Reveal>
            <div className="text-[10px] uppercase tracking-[0.5em] text-[oklch(0.86_0.13_88)]">— About Company</div>
            ...
            <div className="mt-10 grid grid-cols-2 gap-3 sm:gap-6">
              {stats.map((s) => (
                <div key={s.l} className="corner-frame rounded-xl border border-[oklch(0.78_0.15_85)]/30 bg-white/[0.02] p-4">
...
<div className="flex flex-col sm:grid sm:grid-cols-[minmax(0,240px)_1fr]">
  <div className="relative aspect-[4/5] w-full shrink-0 overflow-hidden bg-[oklch(0.24_0.04_265)] sm:aspect-auto sm:h-full">
                ...
                <div className="p-6 sm:p-8">
                  <div className="text-[10px] font-bold uppercase tracking-[0.35em] text-[oklch(0.86_0.13_88)]">Founder &amp; CEO</div>
                  ...
                  <div className="mt-6 flex items-center gap-3">
                    <div className="h-px flex-1 bg-gradient-to-r from-[oklch(0.86_0.13_88)]/60 to-transparent" />
                    <span className="font-display text-xs italic text-[oklch(0.86_0.13_88)]">— T. I. Khan</span>
                  </div>
                </div>
              </div>
            </motion.div>
  ...
  return (
    <section id="services" className="relative py-24 md:py-32">
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        <Reveal>
          <div className="text-[10px] uppercase tracking-[0.5em] text-[oklch(0.86_0.13_88)]">— Services We Offer</div>
          ...
          {SERVICES.map((s, i) => {
            ...
            return (
              <Reveal key={s.slug} delay={i * 0.08}>
                <div className="svc-card corner-frame group h-full rounded-2xl border border-white/10 bg-[oklch(0.19_0.04_265)] p-8 transition-all duration-500 hover:-translate-y-1 hover:border-[oklch(0.78_0.15_85)]/60">
                  <div className="grid h-16 w-16 place-items-center rounded-2xl shadow-[0_10px_30px_-8px_rgba(0,0,0,0.6)] transition-transform duration-500 group-hover:scale-110"
                    style={{ background: "linear-gradient(135deg, #f0d78c, #c9a84c)" }}>
                    <Icon className="h-8 w-8 text-[oklch(0.15_0.03_265)]" strokeWidth={2.2} />
                  </div>
                  ...
                  <ul className="mt-5 space-y-1.5 text-[13px] text-white/55">
                    {s.highlights.map((h) => (
                      <li key={h} className="flex items-start gap-2">
                        <span className="mt-1 h-1 w-1 shrink-0 rounded-full bg-[oklch(0.86_0.13_88)]" /> {h}
                      </li>
                    ))}
                  </ul>
                  <Link to="/services" className="mt-6 inline-block gold-link text-[11px] font-bold uppercase tracking-[0.28em] text-[oklch(0.86_0.13_88)]">
                    Read More →
                  </Link>
                </div>
              </Reveal>
...
function Philosophy() {
  ...
  return (
    <section className="section-light relative py-24 md:py-32">
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        <Reveal>
          <div className="text-[10px] uppercase tracking-[0.5em] text-[oklch(0.62_0.16_78)]">— Our Benefits</div>
          <h2 className="mt-4 font-display text-[clamp(1.9rem,7.5vw,3.75rem)] leading-[1.05]">
          ...
          {items.map((it, i) => (
            <Reveal key={it.title} delay={i * 0.08}>
              <div className="light-card corner-frame h-full rounded-2xl p-8 transition hover:-translate-y-1">
                <div className="font-display text-[10px] uppercase tracking-[0.4em] text-[oklch(0.62_0.16_78)]">0{i + 1}</div>
...
function Work() {
  return (
    <section id="work" className="relative py-24 md:py-32">
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        <Reveal>
          <div className="text-[10px] uppercase tracking-[0.5em] text-[oklch(0.86_0.13_88)]">— Our Portfolio</div>
          <h2 className="mt-4 font-display text-[clamp(1.9rem,7.5vw,3.75rem)] leading-[1.05]">
...
function Process() {
  return (
    <section className="section-light relative py-24 md:py-32">
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        <Reveal>
          <div className="text-[10px] uppercase tracking-[0.5em] text-[oklch(0.62_0.16_78)]">— How We Work</div>
          <h2 className="mt-4 font-display text-[clamp(1.9rem,7.5vw,3.75rem)] leading-[1.05]">
          ...
          {PROCESS.map((p, i) => (
            <Reveal key={p.n} delay={i * 0.08}>
              <div className="light-card corner-frame relative h-full rounded-2xl p-7 transition hover:-translate-y-1">
                <div className="font-display text-6xl font-black text-[oklch(0.62_0.16_78)]/25">{p.n}</div>
  ...
  return (
    <section id="contact" className="relative overflow-hidden py-20 md:py-40">
      ...
      <div className="relative mx-auto max-w-4xl px-4 text-center sm:px-6">
        <Reveal>
          <div className="text-[10px] uppercase tracking-[0.5em] text-[oklch(0.86_0.13_88)]">— Let's Build</div>
          ...
          <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
            <a href={WA_HREF} target="_blank" rel="noopener noreferrer"
              ...
              className="rounded-full bg-[oklch(0.78_0.15_85)] px-8 py-4 text-[11px] font-bold uppercase tracking-[0.3em] text-[oklch(0.15_0.03_265)]">
              WhatsApp Us
            </a>
            <Link to="/contact" className="rounded-full border border-white/20 px-8 py-4 text-[11px] font-bold uppercase tracking-[0.3em] text-white/80 hover:border-[oklch(0.78_0.15_85)] hover:text-[oklch(0.86_0.13_88)]">
              Get in Touch
            </Link>
          </div>
        </Reveal>
